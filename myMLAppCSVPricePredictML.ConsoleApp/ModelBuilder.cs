...
namespace MyMLAppCSVPricePredictML.ConsoleApp
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\13sch\source\repos\myMLAppCSVPricePredict\myMLAppCSVPricePredict\taxi-fare-train.csv";
        private static string MODEL_FILEPATH = @"../../../../MyMLAppCSVPricePredictML.Model/MLModel.zip";
